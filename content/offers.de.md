...
Agent-Crawler-Politik, MCP Server Card. Ergebnis in unter einer Minute als
Score 0–100 mit konkreter Mängelliste.

- Keine Zugangsdaten, keine Schreibzugriffe, keine Anmeldung
- 3 Tests pro Tag und IP-Adresse
- **[Jetzt testen](https://mcpclinic.dev/test)**
...
- **Schreib-Sicherheit:** Idempotenz, Bestätigungspflicht bei destruktiven
...
- TypeScript, Streamable HTTP, aktueller Spezifikationsstand
- Pro-Nutzer-OAuth wo Ihre API es hergibt, sonst eingeschränkte Service-Keys
- Pro-Tool-Berechtigungen, Mandantentrennung auf Tool-Ebene
- Schreibaktionen: Idempotenz-Keys, Bestätigungsflow für destruktive Operationen,
  vollständiges Audit-Log
- Tool-Beschreibungen, verifiziert mit 3 Modell-Clients (Regressionstest)
- Agentenlesbare Doku, Beispiele je Standardaufgabe
- Auslieferung: Ihre Infrastruktur (Hetzner/Docker) oder unser EU-Hosting (+49 €/Monat)
- Übergabe mit Tests und Runbook

**Umfang:** eine API, bis zu ~20 Tools. Mehr nach Aufwand, Festpreis nach Audit.
...
- Monatlicher Agenten-Regressionstest gegen Ihren Endpunkt
- Tool-Updates bei API-Änderungen, Prioritäts-Fixes
- Optional: Monitoring-Dashboard im Ihrem Branding

---

## Warum MCP Clinic

- **Wir testen live, statt Formulare zu zählen.** Kostenlose Scanner prüfen, ob
  eine Datei existiert. Wir schicken echte Agenten gegen Ihr Produkt.
- **Festpreise, öffentlich.** Keine Rechnungsstellung auf Anfrage.
- **Deutscher Anbieter, deutsche Zuständigkeit.** DSGVO-Beratung auf Augenhöhe,
